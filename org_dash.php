...
<div class="containe-fluid">
    ...
    <div class="row mt-3 ml-3 mr-3">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <?php echo "HI Welcome back " . $_SESSION['login_name'] . "!"  ?>
                    <hr>
                    <div class="row">
                        ...
                        <?php
                        // print($_SESSION['org']['org_type']);
                        // foreach ($_SESSION['org'] as $key => $value) {
                        //     var_dump($_SESSION[$key]);
                        // $org_type = $_SESSION[$key]['org_type'];
                        // }
                        // print($_SESSION['org_type']);
                        // $org_type = $_SESSION[0]['org_type'];
                        // Printing org_type
                        // echo $org_type;
                        ?>
                        <!-- <div class="col-md-3">

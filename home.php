    ...
    <div class="card" data-id="">
        ...
        <div class="card-body">
            <div class="row  align-items-center justify-content-center text-center h-100">
                <div class="">
                    <p>Welcome hiiiiiiiiiiiii to the Alumni Hub, where cherished connections endure beyond graduation.
                        ...
                        Whether you're seeking career advice, mentorship opportunities, or simply wishing to
                        reminisce about your time], this space is tailored to serve your needs.

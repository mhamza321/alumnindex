...
// Code added by Hamza start *********
if ($action == "load_depts") {
	$loaddept = $crud->load_depts();
	if ($loaddept)
		echo $loaddept;
}
if ($action == "delete_dept") {
	$delete = $crud->delete_dept();
	if ($delete)
		echo $delete;
}
if ($action == "save_dept") {
...
if ($action == "update_org_acc") {
	$save = $crud->update_org_acc();
	if ($save)
		echo $save;
}
if ($action == "delete_org") {
	$delete = $crud->delete_org();
	if ($delete)
		echo $delete;
}
// Code added by Hamza end ***********

<style>
    ...
    nav#sidebar {
        ...
        left: 0;
        width: 250px;
        background: url(admin/assets/uploads/art-cover.jpg);
...
<nav id="sidebar" class='mx-lt-5 bg-dark'>
    ...
    <div class="sidebar-list">
        <a href="index.php?page=org_dash" class="nav-item nav-home"><span class='icon-field'><i class="fa fa-home"></i></span> Dashoboard</a>
        ...
        <?php if ($_SESSION['org']['org_type'] == 1) { ?>
            <a href="index.php?page=departments" class="nav-item nav-courses"><span class='icon-field'><i class="fa fa-list"></i></span> Departments</a>
            <a href="index.php?page=alumni" class="nav-item nav-alumni"><span class='icon-field'><i class="fa fa-users"></i></span> Alumni List</a>
        <?php } ?>
        <!-- <a href="index.php?page=organization" class="nav-item nav-organization"><span class='icon-field'><i class="fa fa-list"></i></span> Organization List</a> -->
        <a href="index.php?page=jobs" class="nav-item nav-jobs"><span class='icon-field'><i class="fa fa-briefcase"></i></span> Jobs</a>
        <?php if ($_SESSION['org']['org_type'] == 1) { ?>
            <!-- <a href="index.php?page=events" class="nav-item nav-events"><span class='icon-field'><i class="fa fa-calendar-day"></i></span> Events1</a> -->
        <?php } ?>
